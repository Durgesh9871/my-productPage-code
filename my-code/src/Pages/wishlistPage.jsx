...
const newData = (uniqueID)=>{
  ...
  return (
    <Box>
     ...
     {wishListArray?.length > 0 &&  <Box shadow="2xl" height="auto" border="1px solid #dbdddf" width={{base:"100%", sm: "100%", md: "100%", lg: "100%" ,xl: "80%",'2xl': "80%",}}  ml="auto" mr="auto" mt="8px"  p="20px" >
